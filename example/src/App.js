...
const App = () => {
  ...
  const [showForMain, handleShowForMain] = useState(true)
  return (
    <div>
      <Container className='mt-3'>
        ...
        <Row>
          <Col>
            <Form>
              <Form.Group>
                <Form.Check
                  label='Handle Spinner show'
                  type='checkbox'
                  onChange={() => handleShowForMain(!showForMain)}
                  id='spinnerShow1'
                />
              </Form.Group>
            </Form>
        ...
        <Row className='justify-content-center'>
          ...
          <p>
            if you want to render loader in div you must to make parent element
            "position:releative" after that the loader will cover the parent
            div. Other wise loader will cover first parent "position:releative"
            element
          </p>
        </Row>
        <Row>
            ...
            <div className='in-container'>
              <ReactFlexyLoader show={show} alpha={alpha} position='top'>
                <div className='text-center text-primary'>
                  ...
                  <br />
                  <em>
                    if you want as a spinner you can pass anything you want{' '}
                  </em>
                </div>
              </ReactFlexyLoader>
            </div>
      ...
      <ReactFlexyLoader show={showForMain}  position="fixed" />
    </div>
  )
}
